...
export default function IncomeHistogram({ filteredTracts, monthlyIncome }) {
  ...
  useEffect(() => {
    ...
    g.selectAll('rect.bar')
      ...
      .attr('fill', (d, i) => {
        if (i === userBracketIdx) return '#e94560'
    ...
    g.append('text')
      .attr('x', ux + labelNudge).attr('y', height - 6)
      .attr('text-anchor', labelAnchor).attr('fill', '#e94560')
      .attr('font-size', 10).attr('font-weight', 600)
      .text(labelText)
      ...
      summaryRef.current.innerHTML = `
        <div class="chart-summary">
          <div class="summary-stats">
            <div class="stat">
              <span class="stat-value" style="color:#e94560">$${(annualIncome / 1000).toFixed(0)}k</span>
              <span class="stat-label">Your income</span>
            </div>
            <div class="stat">
              <span class="stat-value" style="color:#6c5ce7">~$${(estMedian / 1000).toFixed(0)}k</span>
          ...
          <p class="summary-insight">
            ...
            ${context}
            <span style="color:#e94560">Red bar</span> = your bracket, <span style="color:#a0d2db">blue</span> = below you.
          </p>
        </div>
      `
    }
